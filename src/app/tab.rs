...
pub struct Tab {
    ...
    #[cfg(feature = "inpaint")]
    pub pending_auto_harmonic_jobs: Option<Vec<AutoInpaintJob>>,
    ...
    pub style_font_size: String,
    pub style_line_height: String,
    pub style_letter_spacing: String,
...
impl Tab {
    ...
    pub fn home(id: TabId) -> Self {
        ...
        Self {
            ...
            #[cfg(feature = "inpaint")]
            pending_auto_shiftmap_jobs: None,
            #[cfg(feature = "inpaint")]
            pending_auto_harmonic_jobs: None,
            #[cfg(feature = "inpaint")]
            ...
            style_font_size: style.font_size.to_string(),
            style_line_height: style.line_height.to_string(),
            style_letter_spacing: style.letter_spacing.to_string(),
