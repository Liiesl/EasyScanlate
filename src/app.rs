...
pub fn update(app: &mut App, message: Message) -> Task<Message> {
    ...
    match message {
        ...
        Message::Ui(UiEvent::StyleFontSize(text)) => styling::handle_font_size(app, text),
        Message::Ui(UiEvent::StyleLineHeight(text)) => styling::handle_line_height(app, text),
        Message::Ui(UiEvent::StyleLetterSpacing(text)) => styling::handle_letter_spacing(app, text),
